...
async def gemini_session_handler(client_websocket: websockets.WebSocketServerProtocol):
    ...
    try:
        ...
        config[
            "system_instruction"
        ] = """You are a helpful assistant and you MUST always use the query_docs tool to query the document 
                            ...
                            async for response in session.receive():
                                ...
                                if response.server_content is None:
                                    if response.tool_call is not None:
                                        ...
                                        print(
                                            f"Tool call received: {response.tool_call}"
                                        )
                                        ...
                                        print(
                                            f"function_responses: {function_responses}"
                                        )
